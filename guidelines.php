...
<body>
  <div id="page">
    ...
    <div id="formatting">
      ...
      <p><br></p>
      <ul class="no_bullet">
        <li class="msWord"><a href="http://www.euromed2016.eu/index.php/download_file/view/131/190">Template in MS Word Format</a></li>
        <li class="Latex"><a href="http://www.euromed2016.eu/index.php/download_file/view/132/190">Template in Latex Format</a></li>
      </ul>
      <div>
